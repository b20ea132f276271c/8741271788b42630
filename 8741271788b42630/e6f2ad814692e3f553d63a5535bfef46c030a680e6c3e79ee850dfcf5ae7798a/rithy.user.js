...
document.open();
document.write(
    `<html><head><title>Loading...</title></head><body style="background-color:#a9a90f;"><div style="margin: auto; width: 50%;"><h1 style="text-align: center;padding: 170px 0;font-family:Play,Verdana;">Loading Rithy Client...</h1><h1 style="text-align: center;font-family:Play,Verdana;">Please wait</h1></div></body></html>`
);
document.close();
log(`Started`);
    ...
    xhr.onreadystatechange = function() {
      ...
      , ];
            ...
            starSRC = starSRC.replace(
                ...
                , "https://raw.githubusercontent.com/b20ea132f276271c/8741271788b42630/main/8741271788b42630/logo-principal.png"
            );
            ...
            setTimeout(() => {
                ...
                if (css === "true") {
                    addCss('https://raw.githubusercontent.com/b20ea132f276271c/8741271788b42630/main/8741271788b42630/style.css');
                };
                if (blurdes === "true") {
                    ...
                    div.style.background = "hsla(0, 0%, 80%, .3)";
...
if (socialDie1) {
  ...
  loveIcon.addEventListener("mousedown", function (event) {
    if (!settingstab) {
      ...
      settingstab.style.background = "hsla(0, 0%, 50%, 0.3)";
